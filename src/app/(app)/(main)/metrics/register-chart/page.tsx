...
const Page: React.FC = () => {
	...
	const [registerWithProviderData, setRegisterWithProviderData] = useState<
		RegisterWithProviderData[] | null
	>(null);
	...
	const [registerWithProviderBarHovered, setRegisterWithProviderBarHovered] =
		useState(false);
	...
	const RegisterWithProviderTooltip: React.FC<TooltipWithProviderProps> = ({
		active,
		payload,
	}) => {
		if (active && payload && payload.length) {
				...
				<ResponsiveContainer>
					<BarChart
						...
						<Bar
							...
							name="Registers"
							onMouseEnter={() =>
								setRegisterWithProviderBarHovered(true)
							}
							onMouseLeave={() =>
								setRegisterWithProviderBarHovered(false)
							}
						/>
						<Bar
