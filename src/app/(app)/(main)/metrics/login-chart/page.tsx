...
;            }
    ...
    const chartData = data.map(item => ({
        ...
        totalRegistrations: item.loginUsers,
            ...
            <div style={{width: '100%', height: 400}}>
                <ResponsiveContainer>
                    <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 40 }}>
                        ...
                        <YAxis
                            tick={{ fill: '#b6b4b4', fontSize: 14 }}
                            label={{ value: 'Logins', angle: -90, position: 'insideLeft', offset: 10, fill: '#b6b4b4', fontSize: 20, dy: 60 }}
                        />
                        <Tooltip content={<LoginsTooltip/>} cursor={{fill: 'transparent'}} active={barHovered}/>
                        <Legend
                            layout="vertical"
                            align="right"
