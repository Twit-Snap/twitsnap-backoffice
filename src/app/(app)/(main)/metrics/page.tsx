...
const chartOptions = [
    { id: 1, name: 'Register Charts', path: 'register-chart', description: 'Shows amount of successful and failed registers attempts, registers with and without provider and average time' },
    { id: 2, name: 'Login Charts', path: 'login-chart', description: 'Shows amount of successful and failed login attempts, logins with and without provider and average time' },
