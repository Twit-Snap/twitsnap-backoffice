   ...
   /* return (
    ...
    return (
        <div className="mx-10 py-6 h-full flex flex-row">
            <div className="w-full bg-[#868686] shadow rounded-r-md ">
